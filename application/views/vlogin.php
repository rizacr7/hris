...
<!-- Mirrored from themesbrand.com/velzon/html/default/auth-signin-basic.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 13 Mar 2025 15:18:53 GMT -->
<head>
                                ...
                                <div class="p-2 mt-4">
									...
									<?php if ($this->session->flashdata('result_login')) { ?>
										<div class="alert custom-alert-two alert-danger alert-dismissible fade show" role="alert">
											<i class="bi bi-x-circle" data-bs-dismiss="alert"></i>
											<?php echo $this->session->flashdata('result_login'); ?>
										</div>
									<?php } ?>
									
                                    <form action="<?php echo site_url('Welcome/proseslogin'); ?>">
                    ...
                    <div class="col-lg-12">
                        <div class="text-center">
                            <p class="mb-0 text-muted">&copy;
                                <script>document.write(new Date().getFullYear())</script>  Crafted with <i class="mdi mdi-heart text-danger"></i> by Sisfo
                            </p>
                        </div>
                    </div>
                </div>
...
<!-- Mirrored from themesbrand.com/velzon/html/default/auth-signin-basic.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 13 Mar 2025 15:18:54 GMT -->
</html>